...
begin
  ...
  NewTime := TPlayController.CurrentTime - (REWIND_TIME * MediaTimeScale);
  if NewTime >= 0 then
...
begin
  CurrentTime := TPlayController.CurrentTime;
...
begin
  ...
  begin
    ...
    begin
      if TPlayController.Duration > 0 then
      begin
        if TPlayController.CurrentTime >= TPlayController.Duration then
        begin
//          TThread.Queue(nil,
//            procedure
//            begin
