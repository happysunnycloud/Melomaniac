...
begin
  ...
  Result :=
    Round((TPlayController.Duration / TimelineControl.Width) * X);
end;
...
begin
  ...
  X := ATime * (MainForm.TimelineControl.Width / TPlayController.Duration);
  Result := X;
end;
...
begin
  MainForm.ThreadFactory.CreateInlineThread(
